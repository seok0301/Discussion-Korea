...
while True:
    try:
        requests.post("http://115.145.172.80:30303/ping")
    except:
    ...
    if mode == "c":
        ...
        response1 = requests.post("http://115.145.172.80:30303/predictions/classification1", json={'text': text})
        response2 = requests.post("http://115.145.172.80:30303/predictions/classification2", json={'text': text})
        response3 = requests.post("http://115.145.172.80:30303/predictions/classification3", json={'text': text})
        ...
        response = requests.post("http://115.145.172.80:30303/predictions/summarization", json={'text': text})
